class MaintenanceRequest:
    ...
    @classmethod
    def resolve_request(cls, request_id):
        cls.requests = [
            request for request in cls.requests if request.request_id != request_id]
        print(f"Maintenance request {request_id} resolved.")
...
MaintenanceRequest.resolve_request("R001")
MaintenanceRequest.view_requests()
